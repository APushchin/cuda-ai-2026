...
|default|bolshakova_viktoriya|**7/7**|**176**|
...
|default|lukicheva_polina|5/7|133|
|default|malinin_nikita|**7/7**|**269**|
|default|novozhilov_mikhail|**7/7**|**187**|
|default|pashchenkov_maxim|1/7|31|
|default|pigasin_dmitry|**7/7**|**305**|
|default|pinegina_natalia|**7/7**|**265**|
|default|pisarevsky_vadim|**7/7**|**345**|
|default|pushchin_alexey|2/7|55|
|default|putilin_artyom|6/7|145|
|default|rodygin_vadim|6/7|163|
...
|default|volkovskiy_pavel|**7/7**|**205**|
